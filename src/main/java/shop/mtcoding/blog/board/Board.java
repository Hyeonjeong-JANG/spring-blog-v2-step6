...
public class Board {
    ...
    @OrderBy("id desc")
    @OneToMany(mappedBy = "board", fetch = FetchType.LAZY, cascade =CascadeType.REMOVE )// Entity 객체의 변수명 -> board라는 필드명이 포린키의 주인이다. // 여기서의 board는 Reply Entity에 private Board board; 얘다.
